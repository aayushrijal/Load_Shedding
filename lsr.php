...
<section>
        ...
        <div id='search_group'>Select your Location <input type='searchbox' class='search_box' placeholder=' Your location here'/><a href='#'><img src='location.svg'         height='28px' width='28px' id='search' onClick='location_select()'></a></div>
       ...
       <div id='time_remain'>Time Remaining:<span id='timer'></span></div>
        ...
        <br>
                <br>
<div id='tools'>
        <div class='setting'><a href='#'><img src='setting.svg' height='23px' width='23px'></a></div>
        <div class='update'><a href='#'><img src='update.svg' height='20px' width='20px'></a></div>        
        <div class='download'><a href='lsr_generate_pdf.php' target='_blank'><img src='download.svg' height='27px' width='30px'></a></div>
</div>
